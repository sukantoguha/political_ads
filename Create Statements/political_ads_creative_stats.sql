...
--
-- Table structure for table `creative_stats`
--
...
CREATE TABLE `creative_stats` (
  ...
  `ad_campaigns_list` varchar(500) DEFAULT NULL,
  `start_date` datetime DEFAULT NULL,
  `end_date` datetime DEFAULT NULL,
  `num_of_days` int(11) DEFAULT NULL,
  `impressions` varchar(45) DEFAULT NULL,
  `spend_range_min_usd` int(11) DEFAULT NULL,
  `spend_range_max_usd` int(11) DEFAULT NULL,
  PRIMARY KEY (`ad_id`,`advertiser_id`)
