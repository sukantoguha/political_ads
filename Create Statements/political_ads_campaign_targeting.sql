...
CREATE TABLE `campaign_targeting` (
  ...
  `age_targeting` varchar(500) DEFAULT NULL,
  `gender_targeting` varchar(500) DEFAULT NULL,
  `geo_targeting_included` varchar(500) DEFAULT NULL,
  `start_date` datetime DEFAULT NULL,
  `end_date` datetime DEFAULT NULL,
  `ads_list` varchar(500) DEFAULT NULL,
