...
--
-- Table structure for table `top_keywords_history`
--

DROP TABLE IF EXISTS `top_keywords_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `top_keywords_history` (
  `region` varchar(45) NOT NULL,
  `elections` varchar(45) NOT NULL,
  ...
  `keyword_6` varchar(100) DEFAULT NULL,
  `spend_usd_1` int(11) DEFAULT NULL,
  `spend_usd_2` int(11) DEFAULT NULL,
  `spend_usd_3` int(11) DEFAULT NULL,
  `spend_usd_4` int(11) DEFAULT NULL,
  `spend_usd_5` int(11) DEFAULT NULL,
  `spend_usd_6` int(11) DEFAULT NULL,
  PRIMARY KEY (`region`,`elections`,`report_date`)
